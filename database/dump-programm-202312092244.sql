...
-- Started on 2023-12-09 22:44:30
...
--
-- TOC entry 255 (class 1255 OID 16811)
...
--
-- TOC entry 248 (class 1255 OID 16782)
...
--
-- TOC entry 250 (class 1255 OID 16772)
...
--
-- TOC entry 253 (class 1255 OID 16808)
...
--
-- TOC entry 249 (class 1255 OID 16769)
...
--
-- TOC entry 258 (class 1255 OID 16842)
-- Name: view_courses(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.view_courses() RETURNS TABLE(course_title character varying, description_course character varying)
    LANGUAGE plpgsql
    AS $$
	begin
return query
select description as course_title, full_description as description_course 
from study;
	END;
$$;
...
--
-- TOC entry 256 (class 1255 OID 16840)
-- Name: view_done_homeworks(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.view_done_homeworks(t_id integer) RETURNS TABLE(name character varying, lastname character varying, hw_description character varying, course_description character varying, answer character varying, mark integer)
    LANGUAGE plpgsql
    AS $$
	begin
return query
...
--
-- TOC entry 257 (class 1255 OID 16841)
-- Name: view_marks(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.view_marks(studygroup_id integer) RETURNS TABLE("Course_description" character varying, name character varying, lastname character varying, "All_hw" bigint, "Done_hw" bigint, "Average_mark" numeric)
    LANGUAGE plpgsql
    AS $$
	begin
return query
...
--
-- TOC entry 251 (class 1255 OID 16794)
...
--
-- TOC entry 254 (class 1255 OID 16809)
...
INSERT INTO public.study OVERRIDING SYSTEM VALUE VALUES (1, 'Introduction to Data Science', '{"Курс \"Основы Data Science\" предоставляет фундаментальные знания для вхождения в захватывающий мир анализа данных. Студенты освоят ключевые концепции статистики, машинного обучения и программирования на языке Python. Программа включает в себя практические занятия по обработке данных, визуализации и построению моделей. По завершении курса участники будут готовы к решению реальных задач в сфере аналитики и принятию обоснованных решений на основе данных."}');
INSERT INTO public.study OVERRIDING SYSTEM VALUE VALUES (2, 'Frontend development', '{"Курс \"Frontend разработка\" представляет собой погружение в захватывающий мир веб-технологий. Студенты изучат основы HTML, CSS и JavaScript, освоив навыки создания динамичных и интерактивных пользовательских интерфейсов. Программа включает в себя обучение современным фреймворкам, таким как React или Vue.js, а также принципам адаптивного дизайна для мобильных устройств. Практические проекты позволят студентам немедленно применить полученные знания, подготовив их к разнообразным сценариям реального мира в области веб-разработки. По завершении курса участники будут владеть ключевыми навыками для создания современных и отзывчивых пользовательских интерфейсов."}');
INSERT INTO public.study OVERRIDING SYSTEM VALUE VALUES (3, 'Backend development', '{"Курс \"Backend разработка\" предлагает углубленное понимание серверной стороны веб-приложений. Участники освоят языки программирования, такие как Python, Java или Node.js, и изучат принципы работы с базами данных, обеспечивая эффективное хранение и обработку данных. В ходе обучения затрагиваются темы безопасности, оптимизации производительности и разработки API. Практические проекты позволят студентам реализовать полноценные бэкенд-решения, а также разобраться в вопросах масштабирования приложений. По завершении курса участники будут готовы к созданию надежных и мощных серверных систем для поддержки современных веб-приложений."}');
...
INSERT INTO public.studygroup OVERRIDING SYSTEM VALUE VALUES (10, 3, NULL);
...
SELECT pg_catalog.setval('public.studygroup_studygroup_id_seq', 10, true);
...
-- Completed on 2023-12-09 22:44:30
